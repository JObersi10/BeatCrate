...
DECLARE_CLASS_CODEGEN(AppleMusicSearch::UI, BSMapTableViewCell, HMUI::TableCell) {
    DECLARE_CTOR(ctor);
    ...
    DECLARE_INSTANCE_FIELD(TMPro::TextMeshProUGUI*, mapNameTextView_);
    DECLARE_INSTANCE_FIELD(TMPro::TextMeshProUGUI*, uploaderTextView_);

public:
    static constexpr std::string_view CELL_REUSE_ID = "BSMapTableViewCell";
    void setMap(const AppleMusicSearch::BSMap& map);
private:
